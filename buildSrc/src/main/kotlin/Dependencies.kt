...
//    const val scalars = "com.squareup.retrofit2:converter-scalars:2.9.0"
    // okhttp request
    const val logging = "com.squareup.okhttp3:logging-interceptor:5.0.0-alpha.2"
    const val squareUp = "com.squareup.okhttp:okhttp:2.7.5"
}
...
object GlideLib{
    ...
    const val glide_annotation="com.github.bumptech.glide:compiler:4.11.0"
}